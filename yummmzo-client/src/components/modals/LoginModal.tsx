...
import type { LoginModalProps } from "@/types/prop-types/authPropTypes";
                        ...
                        <div className="relative bg-card border border-border rounded-[2rem] shadow-lg overflow-hidden">
                            <div className="p-8 md:p-10">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Button disabled={loginMutation.isPending} onClick={handleLogin} className="w-full h-12 bg-primary hover:bg-primary/90 text-black font-bold uppercase text-xs tracking-wider rounded-xl transition-all active:scale-[0.98] mt-2">
                                        Login
                                    </Button>
